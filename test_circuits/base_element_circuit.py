...
def base_element_circuit(start_t=0, end_t=1):
    ...
    circuit.add_element(VoltageSource(lambda t: smp.sin(2 * smp.pi * t)), (0, 1), (True,))
    circuit.add_element(Resistance(100), (1, 2), (True,))
    circuit.add_element(Resistance(50), (2, 3), (True,))
    circuit.add_element(Capacitance(1e-12), (2, 0), (True,))
    circuit.add_element(Inductance(1e-9), (3, 0), (True,))
